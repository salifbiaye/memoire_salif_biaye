...
Chaque validation d'ordre, modification de donnée ou changement de statut doit
être enregistré afin de pouvoir retrouver l'historique des opérations.

\paragraph{Disponibilité}
Le système doit rester accessible afin que les utilisateurs puissent consulter
les informations nécessaires à leur travail.

\paragraph{Évolutivité}
Il doit être possible d'ajouter un module ou une fonctionnalité sans reprendre
