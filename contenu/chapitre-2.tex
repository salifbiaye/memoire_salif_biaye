...
\begin{figure}[H]
    \centering
    \includegraphics[width=\dimexpr\textwidth-2\fboxsep-2\fboxrule\relax]{images/contenu/chapitre-2/use_case_relation_client.png}
    \caption{Liste des fonctionnalités du module Relation Client}
    \label{fig:fonctionnalites_rc}
\end{figure}

Dans la suite, nous allons détailler la fonctionnalité gestion des prospects.
% ─────────────────────────────────────────────────
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\dimexpr\textwidth-2\fboxsep-2\fboxrule\relax]{images/contenu/chapitre-2/use_case_sgi.png}
