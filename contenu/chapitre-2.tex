...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/contenu/chapitre-2/use_case_relation_client.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/contenu/chapitre-2/use_case_sgi.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.9\textheight,keepaspectratio]{images/contenu/chapitre-2/sgi_seq_passage_ordres.png}
...
I-SIB pour les modules Relation Client et SGI. Les fonctionnalités décrites couvrent la
gestion de la relation client, la conformité KYC, le suivi des portefeuilles et le
traitement des ordres de bourse. Chaque fonctionnalité a été détaillée à travers une fiche
textuelle structurée et illustrée par un diagramme de séquence. Ces besoins s'accompagnent
