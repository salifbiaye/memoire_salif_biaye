...
Après la présentation du cadre général du projet, ce deuxième chapitre est consacré à l'analyse des besoins auxquels doit répondre le futur système I-SIB dans le périmètre des modules Relation Client et SGI. Il s'agit d'identifier les utilisateurs concernés, de préciser le rôle du système, les fonctionnalités attendues ainsi que les principales exigences de qualité à prendre en compte.

Dans de nombreux établissements, les activités de relation client et les activités d'investissement sont gérées séparément. Les données clients, les informations KYC, les comptes bancaires, les portefeuilles et les ordres de bourse sont souvent répartis entre plusieurs outils. Les utilisateurs doivent alors passer d'une application à l'autre pour accéder aux informations nécessaires.

L'analyse présentée dans ce chapitre vise donc à définir les besoins d'une solution capable de réunir ces différents domaines au sein d'une même plateforme.
...
Le système réunit au sein d'une même plateforme les fonctionnalités liées à la relation client et aux activités d'investissement.
Chaque utilisateur accède uniquement aux informations et aux actions correspondant à son rôle.

% ─────────────────────────────────────────────────
\section{Fonctionnalités du système}

I-SIB comprend deux modules principaux. Le module \textbf{Relation Client} regroupe les fonctionnalités liées à la gestion des clients, au suivi des prospects et aux activités commerciales. Le module \textbf{SGI} (Société de Gestion et d'Intermédiation) prend en charge les opérations liées aux investissements, notamment le suivi des portefeuilles et le traitement des ordres de bourse.
