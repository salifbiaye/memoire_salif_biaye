...
bourse. La présente section étudie successivement les fonctionnalités de chacun
de ces modules. Pour chaque module, une figure présente d'abord une vue
synthétique des fonctionnalités et des interactions avec les acteurs. Les
fonctionnalités retenues sont ensuite détaillées au moyen de tableaux
descriptifs et de représentations graphiques adaptées aux scénarios étudiés.
