...
C'est dans ce contexte que s'inscrit le présent mémoire, réalisé au sein de l'entreprise INNOV4AFRICA dans le cadre d'un stage de deuxième cycle. Le travail effectué porte sur la conception et le développement d'un système d'information bancaire intelligent dénommé \textbf{I-SIB}, en mettant l'accent sur deux modules complémentaires : un module dédié à la gestion de la relation client, inspiré des principes du CRM \cite{payne_frow_crm}, et un module SGI, relatif aux Sociétés de Gestion et d'Intermédiation \cite{crepmf_sgi}.
...
\begin{itemize}
    ...
    \item Le \textbf{troisième chapitre} est consacré à la conception de la solution : son architecture, ainsi que les choix technologiques qui la sous-tendent.
