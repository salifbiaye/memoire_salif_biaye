...
Le développement a été mené selon une approche itérative et incrémentale. Toutes les deux semaines, les fonctionnalités réalisées étaient présentées et évaluées. Les retours des experts métiers permettaient d'affiner les développements avant leur intégration progressive au sein d'I-SIB.
