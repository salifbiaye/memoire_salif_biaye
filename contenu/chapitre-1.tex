...
Le projet est soumis à plusieurs contraintes majeures, notamment en matière de sécurité, de conformité réglementaire (KYC), de traçabilité des opérations, d'ergonomie des interfaces et d'intégration avec le cœur du système bancaire existant \cite{fatf_digital_id,owasp_asvs}.
...
\begin{enumerate}
  ...
  \item \textbf{client aux besoins évolutifs : } Les attentes du client peuvent évoluer après visualisation des écrans ou des scénarios fonctionnels. Une démarche itérative avec des retours réguliers permet d'ajuster le backlog et de prioriser les fonctionnalités pertinentes;
  \item \textbf{validation itérative :} recueillir les retours, ajuster le
        backlog et prioriser les fonctionnalités;
  \item \textbf{cadre d'alternance : } La contribution progresse avec l'apprentissage, les validations encadrantes et les contraintes de l'équipe projet. Des livrables intermédiaires structurent la progression, permettent l'encadrement et favorisent la montée en responsabilité.
\end{enumerate}
\section*{Conclusion}
