...
\begin{description}[itemsep=1pt,parsep=0pt]
    ...
    \item[Sécurité et traçabilité.] Keycloak \cite{keycloak_docs} centralise
          l'authentification. Le module Manager permet d'administrer les
          habilitations selon les rôles et les fonctionnalités, tandis que la
          section Audit du back-office d'administration rend consultables les
          requêtes et opérations enregistrées.
...
\begin{description}[itemsep=1pt,parsep=0pt]
    ...
    \item[Passage en production à préparer.] L'environnement de validation
          ...
          soient intégrées, des tests systématiques d'habilitation, un audit
...
annexes~\ref{ann:recette-fonctionnelle} à~\ref{ann:validation-deploiement}.
