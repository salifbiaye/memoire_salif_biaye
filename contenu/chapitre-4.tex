...
d'accès actuel à la BRVM \cite{brvm_actions} comme source officielle de marché.
Cette phase permet de vérifier le
...
\begin{description}[itemsep=1pt,parsep=0pt]
    ...
    \item[Déploiement de validation.] La plateforme a été installée sur un VPS
          AlmaLinux \cite{almalinux_official} pour tester les services réalisés et le redéploiement
