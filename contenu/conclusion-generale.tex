...
la consultation des portefeuilles, des instruments BRVM et des informations
...
AlmaLinux, avec une organisation basée sur Docker et Docker Compose afin de
tester progressivement les services réalisés.

Le travail réalisé reste toutefois à consolider avant une exploitation en
production. Les données de marché utilisées pour les cotations BRVM sont encore
