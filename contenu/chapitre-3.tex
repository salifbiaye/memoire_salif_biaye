...
présente l'organisation des composants et la séparation des réseaux de
conteneurs.

Dans cet environnement de test, la plateforme I-SIB est décomposée en quatre
ensembles Compose indépendants. Cette organisation suit une logique de
...
utilisateur \cite{docker_compose_docs}. En local, cette organisation reste
alignée avec Docker Compose ; sur le VPS AlmaLinux utilisé pour la validation,
elle a été exécutée avec Podman Compose.

Deux réseaux de conteneurs structurent la communication entre les services. Le réseau
...
progressive de la solution et reste distinct de la production.
% ─────────────────────────────────────────────────
\section*{Conclusion}
\phantomsection
