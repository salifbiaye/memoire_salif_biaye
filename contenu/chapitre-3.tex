...
\cite{spring_gateway_docs}, qui constitue le point d'entrée de la plateforme. Les requêtes des applications y transitent avant d'être dirigées vers les microservices concernés. La gestion des utilisateurs et des droits d'accès est assurée par \textbf{Keycloak}
\cite{keycloak_docs}, tandis que \textbf{Netflix Eureka}
\cite{spring_eureka_docs} facilite la découverte des services au sein de l'architecture.
