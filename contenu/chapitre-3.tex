...
Plusieurs principes ont guidé cette organisation. Séparer les responsabilités,
pour commencer, afin que chaque module --- Relation Client, SGI,
authentification, audit ou services transversaux --- garde un périmètre clair.
Un composant dédié filtre les accès entrants et ne laisse atteindre les services
métier que les requêtes autorisées. Les données sensibles, elles, restent
cloisonnées par service, avec des accès restreints selon les rôles. La
traçabilité porte sur les opérations les plus sensibles, comme le KYC, les
prospects, les portefeuilles ou les ordres de bourse. L'ensemble doit aussi
pouvoir évoluer sans tout casser, en gardant des interfaces cohérentes côté
clients comme côté équipes internes.
