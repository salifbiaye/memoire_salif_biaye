...
La figure distingue le \textbf{Service CRM}, responsable des traitements
métier, de la \textbf{Base de données CRM}, utilisée pour la persistance du
prospect et de son état de conversion.
...
\begin{tabularx}{\textwidth}{|p{1.45cm}|p{5.65cm}|X|}
\hline
...
POST   & {\scriptsize\texttt{/api/crm/prospects/\{id\}/activities}} & Ajouter une interaction ou relance \\ \hline
POST   & {\scriptsize\texttt{/api/crm/prospects/\{id\}/convert}}   & Convertir un prospect qualifié en client \\ \hline
\end{tabularx}
\end{table}
...
techniques sont prévues en annexe~\ref{ann:validation-deploiement}.
% ─────────────────────────────────────────────────
\section*{Conclusion}
\phantomsection
