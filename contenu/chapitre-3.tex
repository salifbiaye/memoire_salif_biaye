...
\texttt{module} et \texttt{office}. Après une évolution validée, la chaîne de
livraison reconstruit et redéploie les composants concernés sur le VPS. Cet
accès au VPS permet de vérifier progressivement le fonctionnement des services
réalisés.
% ─────────────────────────────────────────────────
\section*{Conclusion}
\phantomsection
