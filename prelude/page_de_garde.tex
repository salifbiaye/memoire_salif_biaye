...
\begin{tabular}{@{}p{5.2cm} p{4.3cm} p{5.1cm}@{}}
  ...
  \textcolor{bleuESP}{ENCADRANT}            & Pr Ibrahima Fall  & Professeur titulaire du CAMES \\[1pt]
  \textcolor{bleuESP}{MAÎTRE DE STAGE}      & Khassoum WONE     & Ingénieur Informatique \\[1pt]
  \textcolor{bleuESP}{DIRECTEUR DE MÉMOIRE} & Pr Ibrahima Fall  & Professeur titulaire du CAMES \\
\end{tabular}
